# -*- coding: utf-8 -*-
"""
Created on Wed Jun 20 16:37:03 2018
...
conn = sqlite3.connect(r"C:\PyCodes\Database\trackdb.sqlite")
cur = conn.cursor()
...
for song in songs:
    ...
    info = (name, artist, album, count, rating , length)
    if None in info:
        skipped_2 += 1
        continue
    print(info)
